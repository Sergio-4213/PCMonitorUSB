...
static Task TestWindowLayout()
{
    ...
    var thread = new Thread(() =>
    {
        try
        {
            ...
            var output = Path.Combine(Path.GetTempPath(), "PCMonitorUSBTests", "settings-layout-2.3.2.png");
            ...
            Application.DoEvents();
            var dashboardOutput = Path.Combine(Path.GetTempPath(), "PCMonitorUSBTests", "dashboard-server-toggle-2.3.2.png");
